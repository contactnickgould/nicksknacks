...
var w = c.width = window.innerWidth,
    ...
    animating = !1,
    Tau = 2 * Math.PI;
ctx.fillStyle = "#222", ctx.fillRect(0, 0, w, h), ctx.fillStyle = "#ccc", ctx.font = "50px Verdana", ctx.fillText("Calculating Nodes", w / 2 - ctx.measureText("Calculating Nodes").width / 2, h / 2 - 15), window.setTimeout(init, 4), Connection.prototype.link = function () {
    ...
    opts.vanishPoint.x = (w = c.width = window.innerWidth) / 2, opts.vanishPoint.y = (h = c.height = window.innerHeight) / 2, ctx.fillRect(0, 0, w, h)
